...
//  has a default value equal to 5. It seems this value is ok for all bit rates
//  but at 1 Mbit/s nominal bit rate, and a data bit rate factor x8 (8 Mbit/s), 
...
void setup() {
  ...
  settings.mTransceiverDelayCompensation = 4; // At 8MBit/s - 3 does not work, 4 works, 5 works, 6 does not work
