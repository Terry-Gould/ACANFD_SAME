...
static ACANFD_SAME_FIFO gStandardBuffer;
static ACANFD_SAME_FIFO gExtendedBuffer;

void setup() {
  gStandardBuffer.initWithCapacity(100);
  gExtendedBuffer.initWithCapacity(100);
