...
void setup() {
  ...
  digitalWrite(PIN_CAN1_STANDBY, false);  // turn off STANDBY
  ...
  // This sends data to the transciever and loops it back to the RX so you can read them back.
  // Change to INTERNAL_LOOP_BACK if you want to test without the transciever, this will then only test the internal controller.
