...
void setup() {
  ...
  standardFilters.addClassic(0x405, 0x7D5, ACANFD_SAME_FilterAction::FIFO0);
  //--- Add range filter: low bound, high bound (36 matching identifiers)
  standardFilters.addRange(0x100, 0x123, ACANFD_SAME_FilterAction::FIFO1);
  //--- Add dual filter: identifier1, identifier2 (2 matching identifiers)
  standardFilters.addDual(0x033, 0x44, ACANFD_SAME_FilterAction::FIFO0);
  //--- Add single filter: identifier (1 matching identifier)
  standardFilters.addSingle(0x055, ACANFD_SAME_FilterAction::FIFO0);
