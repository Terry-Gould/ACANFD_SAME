...
#include <ACANFD_SAME_DataBitRateFactor.h>

class CANFDMessage ;

//----------------------------------------------------------------------------------------

enum class ACANFD_SAME_FilterAction {
  FIFO0 = 0,
  FIFO1 = 1,
  REJECT = 2
} ;
...
class ACANFD_SAME_Settings {
  ...
  public: typedef enum : uint8_t {
    CLOCK_48MHz = 0,
    CPU_CLOCK = 1,
    CPU_CLOCK_DIVIDED_BY_2 = 2,
    CPU_CLOCK_DIVIDED_BY_3 = 3,
    CPU_CLOCK_DIVIDED_BY_4 = 4,
    CPU_CLOCK_DIVIDED_BY_5 = 5,
    CPU_CLOCK_DIVIDED_BY_6 = 6,
    DPLL1_CLOCK = 7,
    DPLL1_CLOCK_DIVIDED_BY_2 = 8,
    DPLL1_CLOCK_DIVIDED_BY_3 = 9,
    DPLL1_CLOCK_DIVIDED_BY_4 = 10
  } ClockSelection ;
  ...
  //   Note: in version 2.0.0, the clock selection has been inserted as first argument
  //   For compatibility with releases 1.x, insert ACANFD_SAME_Settings::CLOCK_48MHz
  //   as the 48 MHz clock was the only available clock in releases 1.x
  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  public: ACANFD_SAME_Settings (const ClockSelection inClockSelection,
...
//--- Clock selection
  public : ClockSelection mClockSelection ;
...
//-- Accept non matching frames ?
  public: ACANFD_SAME_FilterAction mNonMatchingStandardFrameReception = ACANFD_SAME_FilterAction::FIFO0 ;
  public: ACANFD_SAME_FilterAction mNonMatchingExtendedFrameReception = ACANFD_SAME_FilterAction::FIFO0 ;
...
//--- Get FDCAN clock frequency (in Hz)
  public: uint32_t FDCANClockFrequency (void) const ;
